    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _groupingToggle(cs, S.regrouperParJuz, groupByJuz, onGroupByJuzChanged),
          _groupingToggle(cs, S.regrouperParHizb, groupByHizb, onGroupByHizbChanged),
        ],
      ),
    );
  }

  Widget _groupingToggle(ColorScheme cs, String label, bool value, ValueChanged<bool> onChanged) {
    return Row(
      children: [
